...
glm::mat4 modelMatrixCreeper = glm::mat4(1.0f);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelHeliHeliBack.loadModel("../models/Helicopter/Mi_24_heliback.obj");
	...
	// Buzz
	modelBuzzTorso.loadModel("../models/buzz/buzzlightyTorso1.obj");
	...
	modelBuzzLeftArm.loadModel("../models/buzz/buzzlightyLeftArm1.obj");
	modelBuzzLeftArm.setShader(&shaderMulLighting);
	modelBuzzLeftForeArm.loadModel("../models/buzz/buzzlightyLeftForearm1.obj");
	modelBuzzLeftForeArm.setShader(&shaderMulLighting);
	modelBuzzLeftHand.loadModel("../models/buzz/buzzlightyLeftHand1.obj");
	modelBuzzLeftHand.setShader(&shaderMulLighting);
	modelBuzzRightArm.loadModel("../models/buzz/buzzlightyRightArm1.obj");
	modelBuzzRightArm.setShader(&shaderMulLighting);
	modelBuzzRightHand.loadModel("../models/buzz/buzzlightyRightHand1.obj");
	modelBuzzRightHand.setShader(&shaderMulLighting);
	modelBuzzRightForeArm.loadModel("../models/buzz/buzzlightyRightForearm1.obj");
	modelBuzzRightForeArm.setShader(&shaderMulLighting);
	modelBuzzHip.loadModel("../models/buzz/buzzlightyHip1.obj");
	modelBuzzHip.setShader(&shaderMulLighting);
	modelBuzzRightCalf.loadModel("../models/buzz/buzzlightyRightCalf1.obj");
	modelBuzzRightCalf.setShader(&shaderMulLighting);
	modelBuzzLeftCalf.loadModel("../models/buzz/buzzlightyLeftCalf1.obj");
	modelBuzzLeftCalf.setShader(&shaderMulLighting);
	modelBuzzRightThigh.loadModel("../models/buzz/buzzlightyRightThigh1.obj");
	modelBuzzRightThigh.setShader(&shaderMulLighting);
	modelBuzzLeftThigh.loadModel("../models/buzz/buzzlightyLeftThigh1.obj");
	modelBuzzLeftThigh.setShader(&shaderMulLighting);
	modelBuzzRightFoot.loadModel("../models/buzz/buzzlightyRightFoot1.obj");
	modelBuzzRightFoot.setShader(&shaderMulLighting);
	modelBuzzLeftFoot.loadModel("../models/buzz/buzzlightyLeftFoot1.obj");
	modelBuzzLeftFoot.setShader(&shaderMulLighting);
	modelBuzzRightWing1.loadModel("../models/buzz/buzzlightyRightWing1A.obj");
	modelBuzzRightWing1.setShader(&shaderMulLighting);
	modelBuzzRightWing2.loadModel("../models/buzz/buzzlightyRightWing2A.obj");
	modelBuzzRightWing2.setShader(&shaderMulLighting);
	modelBuzzLeftWing1.loadModel("../models/buzz/buzzlightyLeftWing1A.obj");
	modelBuzzLeftWing1.setShader(&shaderMulLighting);
	modelBuzzLeftWing2.loadModel("../models/buzz/buzzlightyLeftWing2A.obj");
	modelBuzzLeftWing2.setShader(&shaderMulLighting);
	//Creeper y omen
	modelCreeper.loadModel("../models/creeper/Creeper.obj");
	modelCreeper.setShader(&shaderMulLighting);
	modelOmen.loadModel("../models/omen/omen.obj");
...
void applicationLoop() {
	...
	modelMatrixCreeper = glm::translate(modelMatrixCreeper, glm::vec3(20.0, 0.0, -15.0));
	...
	while (psi) {
		...
		*******************************************/
		...
		modelMatrixHeliHeliBack = glm::translate(modelMatrixHeliHeliBack, glm::vec3(0.404046,2.09425,-5.64737));
		...
		//modelmMatrixHip = glm::translate(modelmMatrixHip, glm::vec3(0.001622,0.402356,-0.0027817));
		//modelmMatrixHip = glm::translate(modelmMatrixHip, glm::vec3(-0.001622,-0.402356,0.0027817));
		 ...
		 * Creeper & Omen
		 *******************************************/
		glm::mat4 modelMatrixOmenPj = glm::mat4(modelMatrixOmen);
		modelMatrixOmenPj = glm::scale(modelMatrixOmenPj, glm::vec3(2));
		modelOmen.render(modelMatrixOmen);


		glm::mat4 modelMatrixCreeperPj = glm::mat4(modelMatrixCreeper);
		modelMatrixCreeperPj = glm::scale(modelMatrixCreeper, glm::vec3(2));
		modelCreeper.render(modelMatrixCreeperPj);
		...
		//Animaciones por keyframes para Dart Vader
		//Para salvar los Keygrames
